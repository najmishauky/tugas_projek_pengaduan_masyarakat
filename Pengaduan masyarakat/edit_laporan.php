...
<nav class="navbar navbar-dark bg-dark fixed-top">
  ...
  <div class="container">
      <form action="proses_update.php?id=<?= $data['id']?>" method="POST">
     <div class="mb-3">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Ketik Di sini....." name="isi_laporan" value="<?php echo $data
         ['isi_laporan']?>"></textarea>
     </div>
    <div class="mb-3">
